...
use crate::{EncoderOptions, Error, Feature, Level, Result};
...
pub(crate) struct FrameEncoderCore {
    ...
    /// than the block size outside [`FrameEncoderCore::write`].
    staged: Vec<u8>,
