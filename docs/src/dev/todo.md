...
5. **json.Fast 1.30× residue** (was 1.35×; encode_sequences reserve/raw-pointer rework landed, −0.9% instructions): remaining per-sequence cost candidates — three-channel SIMD for the choose_tables_fast histograms, const-generic log to eliminate the `shr %cl` variable shift.
