...
| decode performance | bulk ahead across the board; streaming ~74-80% | streaming residue is on json/skewed (core-vs-core x1.04-1.37, text narrowed to x1.04-1.22 by the 09-19 staging commits), see [current snapshot](bench/snapshot.md) |
